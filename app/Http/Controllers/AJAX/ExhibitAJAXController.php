...
class ExhibitAJAXController extends Controller
{
	...
	public function set_metadata(Request $request, string $exhibit_id)
	{
	...
	public function create_free_text(Request $request, string $exhibit_id) {
		$index = $request->input('index');
		$heading = $request->input('data.heading');
		$html = $request->input('data.html');
		$is_public = $request->input('data.is_public');
		...
		return response()->json([
			'index' => $free_text->get_id(),
			'indices' => $map,
		]);
	}
	
	public function update_free_text(Request $request,  string $exhibit_id, string $free_text_id) {
	...
	public function delete_free_text(Request $request, string $exhibit_id, string $free_text_id) {
		$exhibit = $this->exhibit_repository->get($exhibit_id);
	...
	public function move_free_text(Request $request, string $exhibit_id, string $free_text_id) {
